...
local function downloadFile(path, func)
	if not isfile(path) then
		local suc, res = pcall(function()
			return game:HttpGet('https://raw.githubusercontent.com/7GrandDadPGN/VapeCompiled/'..readfile('Exhibition/profiles/commit.txt')..'/'..select(1, path:gsub('Exhibition/', '')), true)
		end)
...
local function addBlur(parent)
	...
	blur.Image = getcustomasset('Exhibition/assets/new/blur.png')
...
local hash = loadstring(downloadFile('Exhibition/libraries/hash.lua'), 'hash')()
local prediction = loadstring(downloadFile('Exhibition/libraries/prediction.lua'), 'prediction')()
entitylib = loadstring(downloadFile('Exhibition/libraries/entity.lua'), 'entitylibrary')()
local whitelist = {
	alreadychecked = {},
	customtags = {},
	tagcallback = {},
...
run(function()
	...
	function whitelist:announce(text)
		...
		if success then
			return sendToast({
				toastTitle = text,
				iconImage = getcustomasset('Exhibition/assets/new/vape.png'),
				swipeUpDismiss = true,
		...
		icon.Image = getcustomasset('Exhibition/assets/new/vape.png')
	...
	function whitelist:update(first)
		...
		if not first or whitelist.textdata ~= whitelist.olddata then
			if not first then
				whitelist.olddata = isfile('Exhibition/profiles/whitelist.json') and readfile('Exhibition/profiles/whitelist.json') or nil
			end
			...
			if whitelist.textdata ~= whitelist.olddata then
				...
				pcall(function()
					writefile('Exhibition/profiles/whitelist.json', whitelist.textdata)
				end)
			end
...
run(function()
	...
	local function Added(ent)
		...
		arrow.Visible = false
		arrow.Image = getcustomasset('Exhibition/assets/new/arrowmodule.png')
...
run(function()
	...
	Radar = vape:CreateOverlay({
		Name = 'Radar',
		Icon = getcustomasset('Exhibition/assets/new/radaricon.png'),
...
run(function()
	...
	SessionInfo = vape:CreateOverlay({
		Name = 'Session Info',
		Icon = getcustomasset('Exhibition/assets/new/textguiicon.png'),
	...
	Hide = SessionInfo:CreateTextList({
		...
		Icon = getcustomasset('Exhibition/assets/new/blockedicon.png'),
		Tab = getcustomasset('Exhibition/assets/new/blockedtab.png'),
